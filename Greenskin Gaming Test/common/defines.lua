NDefines = {
	...
	NDiplomacy = {
		...
		MIN_ASKED_TRADE_POWER = 1,					-- Minimum % of someone's trade power can be asked for with the diplomatic action
		...
		GRANT_ELECTORATE_INFLUENCE = 0,					-- The amount of IA Grant Electorate gives.
		...
		TRIBUTE_BASE_ADM = 0,						-- Tributary State: Part Adm tribute, mulitplied by total development
		TRIBUTE_BASE_DIP = 0,						-- Tributary State: Part Dip tribute, mulitplied by total development
		TRIBUTE_BASE_MIL = 0,						-- Tributary State: Base Mil tribute, mulitplied by total development
		TRIBUTE_MAX_MONARCH_POWER = 12.0,				-- Tributary State: Max Adm/Dip/Mil per Tributary
		TRIBUTE_BASE_MANPOWER = 0,					-- Tributary State: Part of yearly manpower given in tribute
	...
	NCountry = {
		...
		ESTATE_MIN_DISTRIBUTED_CROWNLAND = 30.002, 	-- Minimum of crownland when distributing land at start
		...
		CALL_ALLY_DECLINE_PRESTIGE_PENALTY = 0.0,		-- Prestige penalty for declining call for arms
		CLAIM_THRONE_PRESTIGE_PENALTY = -20.0,			-- Prestige penalty when claiming throne
		BREAK_VASSAL_PRESTIGE_PENALTY = 0.0,			-- Prestige penalty when break vassalisation
		...
		CORE_LOSE_PRESTIGE = 0.0,						-- Prestige change when lost core
		ABANDON_CORE_PRESTIGE = 0.0,					-- The cost of abandoning a core that some other country owns.
		...
		BREAK_ALLIANCE_NON_GREAT_POWER_FAVOR_COST = 1000,
		BREAK_ALLIANCE_REQUIRED_OPINION = 400,
		...
		TRADE_FAVORS_FOR_GOLD_FAVOR_COST = 1000,
		TRADE_FAVORS_FOR_GOLD_REQUIRED_OPINION = 400,
		TRADE_FAVORS_FOR_MEN_FAVOR_COST = 1000,
		TRADE_FAVORS_FOR_MEN_REQUIRED_OPINION = 400,
		TRADE_FAVORS_FOR_SAILORS_FAVOR_COST = 1000,
		TRADE_FAVORS_FOR_SAILORS_REQUIRED_OPINION = 400,
	...
	NEconomy = {
		...
		DEBASE_MAX_CORRUPTION = 35,						-- Above this level of corruption, you won't be able to Debase Currency.
	...
	NMilitary = {
		...
		ARMY_DRILL_YEARLY_GAIN = 15.0,					-- Gain from Drilling
		...
		BANNER_MANPOWER_USAGE = 0.33,
		BANNER_REINFORCE_SPEED = -0.25,
		...
		ARMY_ATTRITION_AT_SEA = 4,						-- How many percent attrition units take while loaded onto ships traveling open sea
		...
		CAV_LOOT = 0.4,								-- How many ducats/month will a single full strength cavalry regiment loot?
		...
		NAVAL_BASE_ENGAGEMENT_WIDTH = 30,   		-- Number of ships that can fire per round
		...
		SUPPLY_DEPOT_DURATION_MONTHS = 120,				-- Time until supply depot is removed.
		...
		MERCENARY_COMPANY_HIRING_COST_MONTHS = 66,		-- Initial hiring cost in months of maintenance
		...
		MERCENARY_COMPANY_ARMY_TRADITION = 10.0,		-- At what army tradition mercenaries leaders are generated on.
	...
	NReligion = {
		...
		CONVERSION_ZEAL_DURATION = 1,							-- Amount of days in which you cannot convert the province back.
		...
		REFORM_DESIRE_PER_YEAR = 0.01,								-- Increase of reform descire for each year.
		...
		HARMONY_LOSS_PER_DEV_CONVERTED = 0.0,
		YEARLY_HARMONY_INCREASE_WHEN_HARMONIZING = -1.5,
	...
	NGovernment = {
		...
		COSSACKS_ABILITY_COSSACKS_SPAWN_SIZE = 0.1,
		...
		CONCENTRATE_DEVELOPMENT_CAPITAL_PROPORTION = 0,
		CONCENTRATE_DEVELOPMENT_OTHER_STATE_PROVINCES_PROPORTION = 0,
		FREE_CONCENTRATE_DEVELOPMENT_CAPITAL_PROPORTION = 0,
